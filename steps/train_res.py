...
def main(epx: Runner):
    ...
    for ch in range(n_channels):
        ...
        path_file_pim_in = os.path.join(epx.path_dir_save, 'CH_' + str(ch), 'PIM_B_128_F_1_S_0_M_LINEAR_H_8_P_34068' + '.csv')
        ...
        pim_model_id = epx.gen_model_id(n_net_pim_params) + '_STEP_'+ str(epx.args.step)
    
        print('pim_model_id: ', pim_model_id)
        
        (train_loader, val_loader, test_loader), noise, initial_rxa, means, sd = epx.prepare_residuals(new_data)
